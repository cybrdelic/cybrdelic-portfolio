...
async fn main() {
    ...
    let app = Router::new()
        ...
        .route("/api/projects/:id", get(get_project_details))
        .route("/project/:id", get(serve_project_page))
...
async fn serve_project_page(Path(id): Path<String>) -> Html<String> {
...
async fn get_projects() -> Html<String> {
...
async fn get_project_details(Path(id): Path<String>) -> Json<Project> {
